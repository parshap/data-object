...
module.exports = function(Model) {
	...
	// ### Model#changed
	//
	// Returns an array of attribute name(s) that have changed since the last
	// load or save.
	...
	Model.prototype.set = function(attrs) {
		...
		function setOne(name, val) {
			...
			// Only do anything if the value is actually changing or the value
			// is an object (the object may have changed).
			if ( _.isObject(val) || ! _.isEqual(val, _this.attributes[name])) {
